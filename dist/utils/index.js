    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ret = _context.sent;
            return _context.abrupt('return', ret ? require(cwd(src)) : ret);
...
function exist(src) {
  return new _promise2.default(function (resolve, reject) {
    _fs2.default.access(cwd(src), _fs2.default.R_OK | _fs2.default.W_OK, function (err) {
